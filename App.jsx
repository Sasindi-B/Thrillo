...
function App() {
  ...
  const handleTravellerSignup = async () => {
    if (authMode !== 'signup' || role !== 'traveller') return
                  ...
                  <div className="auth-card light">
                    ...
                    <div className="stacked-actions">
                      <button
                        ...
                        disabled={authLoading || role !== 'traveller'}
                      >
